        ...
        implements UpdatablePageSource
{
        ...
        try {
            for (int i = 0; i < rowIds.getPositionCount(); i++) {
                ...
                for (int fieldPos = 0; fieldPos < pkFields.size(); fieldPos++) {
                    ...
                    Object value = TypeUtils.getObjectValue(field.getType(), singleRowBlock, fieldPos);
    ...
    private String buildDeleteSql()
    {
        ...
        StringBuilder deleteSql = new StringBuilder()
                .append("DELETE FROM ")
                .append(PhoenixMetadata.getFullTableName(split.getCatalogName(), split.getSchemaName(), split.getTableName()))
                .append(" WHERE ")
